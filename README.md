...
### 4. [🧠 AutoML 기반 고객 인사이트 분석](https://github.com/wootae1020/project-mldl)
- 유아용품 쇼핑몰 고객 데이터를 활용한 세그먼트 분류 및 이탈 예측
- 배송일 예측과 텍스트 마이닝을 포함한 종합 분석
- H2O AutoML, NLP, LGBM 등 다양한 기법 적용
